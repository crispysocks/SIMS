...
@router.post('/students/{student_no}', response_model=EmploymentRead, dependencies=[Depends(require_role(['admin', 'teacher']))])
...
@router.put('/students/{student_no}', response_model=EmploymentRead, dependencies=[Depends(require_role(['admin', 'teacher']))])
...
@router.delete('/students/{student_no}', status_code=status.HTTP_204_NO_CONTENT, dependencies=[Depends(require_role(['admin']))])
