...
@router.put('/{teacher_no}', response_model=TeacherRead, summary='更新教师信息', dependencies=[Depends(require_role(['admin']))])
def update_teacher(
    teacher_no: str,
    data: TeacherUpdate,
...
@router.delete('/{teacher_no}', response_model=TeacherRead, summary='删除教师', dependencies=[Depends(require_role(['admin']))])
